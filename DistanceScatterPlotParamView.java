 ...
 */
public class DistanceScatterPlotParamView extends AbstractParametersView {

    /** Creates new form NJConnectionParamView */
    public DistanceScatterPlotParamView(DistanceScatterPlotComp comp) {
        initComponents();
        this.comp = comp;
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Distance ScatterPlot Parameters"));
        ...
        nrNeighborsPanel.add(useWeightCheckBox);
    ...
    private void pointsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pointsButtonActionPerformed
        try {
            ...
            Logger.getLogger(DistanceScatterPlotParamView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private DistanceScatterPlotComp comp;
